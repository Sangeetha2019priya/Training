...
public class CsvParserSimple {
    ...
    public static void main(String[] args) throws Exception {
       ...
       // URL resource = CsvParserSimple.class.getClassLoader().getResource("D:\\Sangeetha priya\\Java\\Maven\\com.kgisl.Spotify\\monitor.csv");
        // File file = Paths.get(resource.toURI()).toFile();
        File file = new File("D:\\Sangeetha priya\\Java\\Maven\\com.kgisl.Spotify\\monitor.csv");
    ...
    public String[] parseLine(String line, char separator) throws Exception {
        ...
        return parse(line, separator, DEFAULT_QUOTE_CHAR).toArray(new String[0]);
